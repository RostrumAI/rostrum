...
- understand the in-memory, required-join fan-out, sequential loop, and supported-step boundaries.
...
- Examples cover sequential success, both branch results, fan-out/fan-in, loops, and failures.
- The guide states the in-memory, required-join fan-out, sequential loop, and supported-step boundaries.
