...
- A product node turns an intent into structured requirements and questions.
...
Adapter interfaces, local/mock providers, context-view contracts, and open-source model adapters belong in the open core. Hosted provider routing, managed model credentials, proprietary evaluation, and cloud cost optimization may be hosted features. Source connectors and pass-through retrieval are specified by PRD-14.
