...
| `DATABASE_URL` / `databaseUrl` | `postgres://rostrum:rostrum@localhost:5432/rostrum` | Postgres target; the database package's migrations ([E1-07](docs/tasks/epic-01/e1-07-add-workflow-draft-version-storage.md)) and the Control API's workflow database in `apps/control-api/src/workflows` use it |
