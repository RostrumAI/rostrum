...
Severity: `critical` is a defect that breaks documented behavior or is exploitable, and it needs
evidence that the code is wrong today. `high` is an obvious bug that can affect functionality, or a
security weakness that takes more than a bug to exploit. `medium` is a repository convention broken at
file or module scope: placement, wiring, a public surface, a missing test for new behavior. `low` is a
line-level problem, such as an unbraced conditional or a comment that restates its code. `informational`
is a suggestion with no defect behind it. Findings at `medium` and above are BLOCKING; `low` findings
should be fixed but do not hold up the change.
...
**Applies to:** `packages/**` · **Check:** judgment · **Severity:** medium
...
**Applies to:** `apps/**`, `apis/**`, `packages/**`, `**/migrations/**` · **Check:** judgment · **Severity:** medium
...
**Applies to:** `packages/**`, `apps/**`, `apis/**` · **Check:** judgment · **Severity:** low
...
**Applies to:** `apps/**/src/**`, `apis/**/src/**`, `packages/**` · **Check:** mechanical · **Severity:** medium
...
**Applies to:** `apps/**/src/**`, `apis/**/src/**`, `packages/**` · **Check:** judgment · **Severity:** low
...
**Applies to:** `packages/**/repositories/**`, `apps/**/src/**`, `apis/**/src/**` · **Check:** judgment · **Severity:** high
...
**Applies to:** `apps/**/src/config*.ts`, `apis/**/src/config*.ts`, `scripts/**` · **Check:** judgment · **Severity:** medium
...
**Applies to:** `packages/**/repositories/**`, `packages/**/schema/**`, `apps/**/src/**` · **Check:** judgment · **Severity:** high
...
**Applies to:** `apps/**`, `apis/**`, `packages/**` · **Check:** mechanical · **Severity:** high
...
**Applies to:** `apps/**`, `apis/**`, `packages/**`, `dev-docs/**`, `**/*.md` · **Check:** judgment · **Severity:** low
...
**Applies to:** `apps/**`, `apis/**`, `packages/**` · **Check:** judgment · **Severity:** low
...
**Applies to:** `apps/**`, `apis/**`, `packages/**`, `dev-docs/**`, `**/*.md` · **Check:** mechanical · **Severity:** low
...
no context.
**Applies to:** `apps/**`, `apis/**`, `packages/**` · **Check:** mechanical · **Severity:** low
...
**Applies to:** `apps/**`, `apis/**`, `packages/**` (excluding `scripts/`, `**/*.test.ts`, and the logger module) · **Check:** mechanical · **Severity:** medium
...
**Applies to:** `**/*.test.ts` · **Check:** mechanical · **Severity:** high
...
**Applies to:** `**/*.test.ts` · **Check:** mechanical · **Severity:** medium
...
**Applies to:** `**/*.test.ts` · **Check:** judgment · **Severity:** low
...
**Applies to:** `**/*.test.ts`, `packages/**/fixtures/**` · **Check:** mechanical · **Severity:** low
...
**Applies to:** `**/*.test.ts`, `packages/**/repositories/**` · **Check:** mechanical · **Severity:** medium
...
**Applies to:** `**/*.test.ts` · **Check:** mechanical · **Severity:** low
...
**Applies to:** `packages/**/fixtures/**`, `packages/**/package.json` · **Check:** mechanical · **Severity:** medium
...
**Applies to:** `packages/**` · **Check:** judgment · **Severity:** low
...
**Applies to:** `**/migrations/**` · **Check:** mechanical · **Severity:** medium
...
**Applies to:** `**/migrations/**`, `**/*.test.ts` · **Check:** mechanical · **Severity:** high
...
**Applies to:** `**/migrations/**` · **Check:** mechanical · **Severity:** high
...
**Applies to:** `**/migrations/**` · **Check:** judgment · **Severity:** low
...
**Applies to:** `packages/**/repositories/**`, `**/migrations/**` · **Check:** judgment · **Severity:** medium
...
**Applies to:** `packages/**/repositories/**`, `**/migrations/**` · **Check:** judgment · **Severity:** high
...
**Applies to:** `packages/**/schema/**`, `packages/**/repositories/**` · **Check:** judgment · **Severity:** medium
...
**Applies to:** `packages/**/repositories/**` · **Check:** judgment · **Severity:** medium
...
**Applies to:** `**/package.json`, `bun.lock` · **Check:** mechanical · **Severity:** informational
...
**Applies to:** `tmp/**`, `scripts/**`, `apps/**`, `apis/**` · **Check:** mechanical · **Severity:** low
...
**Applies to:** `apps/**`, `apis/**`, `packages/**`, `scripts/**` · **Check:** mechanical · **Severity:** medium
