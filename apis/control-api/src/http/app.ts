...
import { errorBody, errorPayloadFor } from "../controllers/workflows/errors";
import { decodeWorkflowBody } from "../controllers/workflows/request-body";
import { Finding } from "../services/workflows/schemas";
...
export function createControlApiApp(): ServerApp<ControlApiContext> {
    ...
    // A controller failure is mapped to its own status when the workflow
    // operations recognize it, and is a Control API fault otherwise.
