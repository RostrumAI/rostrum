/** @fileoverview Workflow publication controller. */
...
import { PublishResponse, type PublishResponseSchema, WorkflowIdSchema } from "./schemas";
 ...
 */
export const publishWorkflow = defineControlController({
    method: "POST",
    ...
    handler: async (request, response, context) => {
        ...
        const result = await context.services.workflows.publish(workflowId);
