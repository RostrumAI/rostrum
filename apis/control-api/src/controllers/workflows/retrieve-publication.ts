/** @fileoverview Publication retrieval controller. */
 ...
 * controller runs.
 */
export const retrieveWorkflowPublication = defineControlController({
    method: "GET",
    ...
    handler: async (request, response, context) => {
        ...
        const publication = await context.services.workflows.getPublication(
            workflowId,
            publicationNumber,
        );
        if (!publication) {
