/** @fileoverview Workflow revision-save controller. */

import { Type } from "typebox";
import { defineControlController } from "../../http/define";
import { CONTROL_API_TAG } from "../../http/tags";
import { ErrorResponse } from "../../schemas";
import { WorkflowApiError, workflowNotFound, workflowRevisionConflict } from "./errors";
import { extractDocumentText } from "./request-body";
import { SaveRevisionRequest } from "./save.schema";
import { revisionResponse, WorkflowIdSchema, WorkflowRevision } from "./schemas";
 ...
 * document omits it.
 */
export const saveWorkflowRevision = defineControlController({
    method: "PUT",
    ...
    handler: async (request, response, context) => {
        ...
        const result = await context.services.workflows.saveRevision(
            workflowId,
