/** @fileoverview Draft retrieval controller. */
 ...
 * reads.
 */
export const retrieveWorkflowDraft = defineControlController({
    method: "GET",
    ...
    handler: async (request, response, context) => {
        ...
        const revision = await context.services.workflows.getCurrentRevision(workflowId);
        if (!revision) {
